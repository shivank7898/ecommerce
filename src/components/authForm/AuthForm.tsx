...
const AuhtForm = ({ signUp = true }) => {
  ...
  const [val, setVal] = useState<UserDetails>({
    name: "",
    email: "",
    password: "",
  });

  const handleChange = (e: React.ChangeEvent<HTMLInputElement>, setFieldValue: (field: string, value: any) => void) => {
