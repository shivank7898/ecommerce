...
import Carasoul, { BreakpointSettings } from "../../../components/carasoul/Carasoul";
...
const LandingFlashSec = () => {
  ...
  const { data, err } = useSelector((state: RootState) => state.product.products);

  const breakpoint: Record<number, BreakpointSettings> = {
    320: {
      slidesPerView: 2,
      spaceBetween: 10,
    },
